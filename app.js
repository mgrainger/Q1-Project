$(document).ready(function() {
    $('form').submit(function(event) {
        ...
        swingAPI = 'https://api.swingbyswing.com/v2/courses/search_by_location?lat=39.7&lng=-104.9&radius=20&active_only=yes&hole_count=18&access_token=9a7a612e-4ccf-4deb-a2da-cde8bc46db01';
